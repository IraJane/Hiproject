...
public class Order {
	...
	public Order(String oemail, String oname, String hname, String orderdate, String checkin, String checkout,
	...
	public String toString() {
		return "Order [oemail=" + oemail + ", oname=" + oname + ", hname=" + hname + ", orderdate=" + orderdate

...
<div class="insertHotel-wrapper">
	<div class="insertHotel-content">
		<div class="wizard-form">
			...
			<!-- ADMIN -->
			<form action="insertHotel.ad" method="post" enctype="multipart/form-data" id="hotelInsertForm" class="form-register">
                     ...
                     <div class="form-row">
                        <div class="form-holder">
                           <fieldset>
                              ...
                              <input type="text" id="postcode" name="h_postcode" class="form-control" placeholder="postcode" readonly="readonly">
                           </fieldset>
                        </div>

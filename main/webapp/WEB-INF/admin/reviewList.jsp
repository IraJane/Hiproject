            ...
            <tr>
               ...
               <c:forEach items="${list }" var="rvc">
                  <tr>
                     ...
                     <td>${rvc.h_name }</td>
                     <td>${rvc.r_type }</td>
                     <td><fmt:formatDate value="${rvc.o_checkin }" pattern="yyyy-MM-dd "/>
                        ~ <fmt:formatDate value="${rvc.o_checkout }" pattern="yyyy-MM-dd "/>
                     </td>
                     ...
                     <td><a href="deleteReview.ad?c_num=${rvc.c_num }" >
